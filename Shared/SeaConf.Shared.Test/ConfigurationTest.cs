...
public class ConfigurationTest
{
	...
	public void Load_ValidData_Success()
	{
		...
		readerMocks.Program
			...
			.ReturnsAsync(() => expectedResult.TimeOnlyValue.ToString(TimeOnlyFormat));
		...
		Assert.That(programSettings, Is.EqualTo(expectedResult).UsingPropertiesComparer(x => x.AllowDifferentTypes()).Within(1).Seconds);
	...
	public void Save_ValidData_Success()
	{
		...
		var programSettings = configuration.GetModel<IProgramSettings>();
		var actualResult = new MockProgramSettings();
		...
		ChangedModelsEventArgs? changedModelsEventArgs = null;
		...
		mockWriter.Program
			...
			.Callback(new InvocationAction(x => actualResult.BytesValue = (ReadOnlyMemory<byte>)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteIntAsync(It.IsAny<int>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.IntValue = (int)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteLongAsync(It.IsAny<long>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.LongValue = (long)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteUlongAsync(It.IsAny<ulong>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UlongValue = (ulong)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteDecimalAsync(It.IsAny<decimal>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.DecimalValue = (decimal)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteDoubleAsync(It.IsAny<double>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.DoubleValue = (double)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.Is<IPropertyInfo>(p => p.Name == nameof(IProgramSettings.StringValue))))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.StringValue = (string)x.Arguments[0]));

		mockWriter.Program
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.Is<IPropertyInfo>(p => p.Name == nameof(IProgramSettings.EnumValue))))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.EnumValue = Enum.Parse<Regime>((string)x.Arguments[0])));
		...
		mockWriter.Program
			...
			{
				actualResult.DateTimeValue = DateTime.Parse((string)x.Arguments[0]);
			}));

		mockWriter.Program
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.Is<IPropertyInfo>(p => p.Name == nameof(IProgramSettings.DateOnlyValue))))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.DateOnlyValue = DateOnly.Parse((string)x.Arguments[0])));

		mockWriter.Program
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.Is<IPropertyInfo>(p => p.Name == nameof(IProgramSettings.TimeOnlyValue))))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.TimeOnlyValue = TimeOnly.Parse((string)x.Arguments[0])));

		mockWriter.Program
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.Is<IPropertyInfo>(p => p.Name == nameof(IProgramSettings.IpEndPointValue))))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.IpEndPointValue = IPEndPoint.Parse((string)x.Arguments[0])));

		mockWriter.Program
			.Setup(x => x.WriteBooleanAsync(It.IsAny<bool>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.BoolValue = (bool)x.Arguments[0]));
		...
		mockWriter.User
			.Setup(x => x.WriteIntAsync(It.IsAny<int>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UserSettings.IntValue = (int)x.Arguments[0]));

		mockWriter.User
			.Setup(x => x.WriteLongAsync(It.IsAny<long>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UserSettings.LongValue = (long)x.Arguments[0]));

		mockWriter.User
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UserSettings.StringValue = (string)x.Arguments[0]));
		...
		mockWriter.Address
			.Setup(x => x.WriteIntAsync(It.IsAny<int>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UserSettings.AddressSettings.IntValue = (int)x.Arguments[0]));

		mockWriter.Address
			.Setup(x => x.WriteLongAsync(It.IsAny<long>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UserSettings.AddressSettings.LongValue = (long)x.Arguments[0]));

		mockWriter.Address
			.Setup(x => x.WriteStringAsync(It.IsAny<string>(), It.IsAny<IPropertyInfo>()))
			.Returns(ValueTask.CompletedTask)
			.Callback(new InvocationAction(x => actualResult.UserSettings.AddressSettings.StringValue = (string)x.Arguments[0]));
		...
		Assert.That(actualResult, Is.EqualTo(expectedResult).UsingPropertiesComparer().Within(1).Seconds);
