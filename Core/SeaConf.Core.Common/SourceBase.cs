...
using SeaConf.Core.Common.Infrastructure;
...
public abstract class SourceBase<TModel> : ISource<TModel>
	where TModel : class, IModel
{
	private bool _isLoaded;
	private protected DisposableHelper DisposableHelper { get; }
	...
	protected void ThrowIfNotLoaded()
	{
		if (!_isLoaded)
		{
			throw new InvalidOperationException(Resources.SourceNotLoaded);
		}
	}
