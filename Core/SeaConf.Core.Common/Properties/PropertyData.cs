...
public abstract class PropertyData : Property, IPropertyData
{
	...
	private static IPropertyData Create(ArgsInfo args)
	{
		...
		if (ctor == null)
		{
			throw new InvalidOperationException(string.Format(Resources.CtorWithRequiredArgsNotFound, genericType.Name));
		}
	...
	public static IPropertyData Create(object value, string name)
	{
	...
	public IPropertyData<T> ToTyped<T>()
	{
		...
		{
			throw new InvalidCastException(string.Format(Resources.PropertyTypeNotCorrect, Type, typeof(T)));
		}
	...
	public IPropertyData ToTyped(Type type)
	{
		...
		if (method == null)
		{
			throw new InvalidOperationException(string.Format(Resources.MethodNotFound, methodName));
		}
...
#pragma warning disable IDE0051
	...
	protected override TData OnGet<TData>()
	{
		...
		{
			throw new InvalidCastException(string.Format(Resources.PropertyTypeNotCorrect, Type, typeof(TData)));
		}
